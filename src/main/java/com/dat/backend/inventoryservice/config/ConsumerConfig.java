package com.dat.backend.inventoryservice.config;
...
public class ConsumerConfig {
    ...
    /**
     * Listener container factory for record listener
     */
    @Bean(name = "recordListenerContainerFactory")
     ...
     */
    @Bean("recordTransactionListenerContainerFactory")
    ...
    @Bean
    public Map<String, Object> txConsumerProperties() {
